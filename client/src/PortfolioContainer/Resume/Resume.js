...
export default function Resume(props) {
  ...
  const resumeDetails = [
    <div className="resume-screen-container" key="education">
      <ResumeHeading
        heading={"Cochin University of Science and Technology, Kochi"}
      ...
      <ResumeHeading
        heading={"GHSS Ngo Quarters"}
        subHeading={"Senior Secondary(XII). Computer Science"}
        fromDate={"2015"}
        toDate={"2017"}
      />
      <ResumeHeading
        heading={"JDT Islam HS"}
        subHeading={"High SChool(X)"}
        fromDate={"2012"}
        toDate={"2015"}
      />
    </div>,
